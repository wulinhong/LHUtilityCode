#
#  Be sure to run `pod spec lint LHUtilityCode.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/wulinhong/LHUtilityCode", :tag => 1.0.0 }
  ...
  s.source_files  = "LHUtilityCode.podspec/**/*.h"
